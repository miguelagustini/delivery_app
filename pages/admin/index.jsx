          ...
          {pizzaList.map((product) => (
            <tbody key={product._id}>
              <tr className={styles.trTitle}>
                ...
                <td>
                  <button className={styles.button} onClick={() => setClose(false)}>Edit</button>
                  {!close && <Edit setClose={setClose} data={product}/>}
                  <button
...
export const getServerSideProps = async (ctx) => {
  ...
  const productRes =  await publicRequest.get("products");
